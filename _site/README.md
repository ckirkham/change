...
- create .eslintrc.json file with configuration inside
...
npm install --save react-native-extended-stylesheet@0.6.0 color@2.0.0 moment@2.18.1 @expo/vector-icons@5.1.0
